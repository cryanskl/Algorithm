...
校招整理: https://juejin.cn/post/7033275515880341512

# 1. 实现一个 compose 函数

compose 定义: https://github.com/ruanyf/es6tutorial/search?utf8=%E2%9C%93&q=compose
...
function compose(...fn){
    ...
    return fn.reduce(
        ...
        //这里是循环调用数组的方法, [fn1,fn2,fn3]变成fn1(fn2(fn3(...args)))
    );
}
```

这里主要是https://juejin.cn/post/6904443997788307463#heading-3

最后一行比如是将数组[aa,bb,cc] 转化为 aa(bb(cc(...args)))
...
题目描述: ![LRU题目.png](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/4e57b38ac1234cf4b1fd926917ab6ae7~tplv-k3u1fbpfcp-watermark.awebp)
...
# 26 请实现 DOM2JSON 函数，可以把一个 DOM 节点输出 JSON 的格式
